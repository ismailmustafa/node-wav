...
Reader.prototype._onDataChunkSize = function (chunk) {
  ...
  this._bytes(chunkSize, this._onProcessDataChunk);
  this._passthrough(chunkSize, this._onDataChunkDone);
};

// Takes in the pure data body
Reader.prototype._onProcessDataChunk = function (dataChunk) {
  this.emit('dataBody', dataChunk);
};
